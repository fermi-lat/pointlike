...
def writeRegion(roi,filename,color='green',label_sources=True,show_localization=True, show_extension=True):
    ...
    file.write(get_region(roi,color,label_sources,show_localization,show_extension))
    file.close()
