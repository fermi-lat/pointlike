...
$Header: /nfs/slac/g/glast/ground/cvs/pointlike/python/uw/like2/diffuse.py,v 1.27 2013/09/27 22:04:10 burnett Exp $
...
class ConvolvableGrid(convolution.BackgroundConvolution):
    ...
    def show_vals(self, vals, ax=None, colorbar=True, **kw):
        """Make a display.
        ...
        v = ax.imshow( vals.transpose()[::-1],  interpolation='nearest', **kw)
...
def mapper(psf, exposure, skydir, source, **kwargs): 
    ...
    try:
        ...
        if not quiet: print '>>>>Loading', source.name, classname
        mapto = dict( 
        ...
        if not quiet: print '\tcalling ', mapto.__class__.__name__
