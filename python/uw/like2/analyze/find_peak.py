...
$Header: /nfs/slac/g/glast/ground/cvs/pointlike/python/uw/like2/analyze/find_peak.py,v 1.11 2013/07/12 22:37:19 burnett Exp $
...
class FindPeak(sourceinfo.SourceInfo):
    """Peak finder
    <b>Analyze a set of FITS images of TS maps, using <a href="http://en.wikipedia.org/wiki/Moment_(mathematics)">moments</a> to estimate positions of peak and extent.
