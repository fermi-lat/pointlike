"""
Analysis code to use a grid of TSmap values to locate a peak
$Headeer$
"""
...
class FindPeak(diagnostic_plots.SourceInfo):
    ...
    def plots(self):
        ...
        <ol><li>peak fraction: fraction of the total weight for the largest bin. This is a check on the scale.
            ...
            <li>locqual : The peak-finding localization quality. This been too large is the primary reason these sources
            were selected. </li>
         </ol>   
