...
$Header: /nfs/slac/g/glast/ground/cvs/pointlike/python/uw/like2/pipeline/uwpipeline.py,v 1.7 2013/01/01 20:09:18 burnett Exp $
"""
import os, argparse
import numpy as np
...
stagenames = dict(
    ...
    tables      =  Stage(pipe.Tables,  job_list='joblist8.txt', help='create tables', ),
