...
$Header: /nfs/slac/g/glast/ground/cvs/pointlike/python/uw/like2/pipeline/check_converge.py,v 1.15 2013/01/15 15:00:49 burnett Exp $
"""
...
def streamInfo( stream, path='.'):
    ...
    print '\tnumber of executions: %s' % np.histogram(times.nex, range(6))[0][1:]
