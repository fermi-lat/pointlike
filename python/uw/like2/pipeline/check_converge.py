...
$Header: /nfs/slac/g/glast/ground/cvs/pointlike/python/uw/like2/pipeline/check_converge.py,v 1.1 2012/11/24 22:33:33 burnett Exp $
"""
...
def main(args):
    ...
    if stage=='update' or stage=='update_full':
        ...
        make_zip('tsmap', 'png')
        make_zip('sedfig', 'png')
        diagnostic_plots.SourceFitPlots(absskymodel).all_plots()
