...
$Header: /nfs/slac/g/glast/ground/cvs/ScienceTools-scons/pointlike/python/uw/like/roi_analysis.py,v 1.74 2011/03/17 23:40:09 lande Exp $
...
class ROIAnalysis(object):
    ...
    def gradient(self,parameters,*args):
        ...
        indices  = N.arange(len(models))[[N.any(m.free) for m in models]]
